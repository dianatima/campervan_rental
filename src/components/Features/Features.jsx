        ...
        <FeaturesWrap>
            <DetailsList>
                ...
                <DetailsItem>
                    ...
                    {adverts.details.beds ? (<DetailsItem> <Beds />{`${adverts.details.beds} beds`}</DetailsItem>) : ("")}
                    {adverts.details.airConditioner ? (<DetailsItem> <Conditioner />{`${adverts.details.airConditioner} air conditioner`}</DetailsItem>) : ("")}
                    {adverts.details.CD ? (<DetailsItem> <CD />CD</DetailsItem>) : ("")}
                    {adverts.details.radio ? (<DetailsItem> <Radio />Radio</DetailsItem>) : ("")}
                    {adverts.details.hob ? (<DetailsItem> <Hob />{`${adverts.details.hob} hob`}</DetailsItem> ) : ("")}
